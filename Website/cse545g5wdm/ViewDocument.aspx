<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewDocument.aspx.cs" Inherits="cse545g5wdm_ViewDocument" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Web Document Management - View Document</title>
<style type="text/css">
.heading
{
	text-align:center;
...
<body>
    <form id="frmViewDocument" runat="server">
    <div class="heading">
        Document Viewing
    </div>
    <div>
